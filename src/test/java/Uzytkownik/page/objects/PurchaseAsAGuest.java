...
public class PurchaseAsAGuest extends BasePage {
    ...
    public PurchaseAsLogged ProductPurchaseAsGuest(String email1) throws InterruptedException {
        LogOut.click();
